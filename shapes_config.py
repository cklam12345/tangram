...
SHAPES = {
    "swan": {
        ...
        "pieces": [
            {
                "color": "red",
                "center": [335, 285],  # Moved closer from [305, 290]
                "angle": 135,
                "piece_type": "large_triangle"
            },
            {
                "color": "green",
                "center": [380, 315],  # Moved closer from [401, 320]
                "angle": 225,  # Was 135, subtracted 90 degrees
                "piece_type": "medium_triangle"
            },
            {
                "color": "blue",
                "center": [350, 315],  # Moved closer from [346, 335]
                "angle": 180,
                "piece_type": "large_triangle"
            },
            {
                "color": "teal",
                "center": [405, 285],  # Moved closer from [426, 280]
                "angle": 45,
                "piece_type": "small_triangle"
            },
            {
                "color": "purple",
                "center": [395, 190],  # Moved closer from [410, 165]
                "angle": 90,
                "piece_type": "small_triangle"
            },
            {
                "color": "yellow",
                "center": [380, 260],  # Moved closer from [399, 241]
                "angle": 315,
                "piece_type": "square"
            },
            {
                "color": "orange",
                "center": [380, 200],  # Moved closer from [378, 186]
                "angle": 45,  # Was 315, added 90 degrees
